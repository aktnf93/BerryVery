...
namespace BerryDevice.Services
{
    public class SerialPortCommService
    {
        ...
        private Timer _comportChecker;

        public bool IsConnected { get; private set; }

        public SerialPortCommService()
        {
        ...
        public void Init(string portName = "COM1", int baudRate = 19200, int dataBits = 8, int stopBits = 1, int parity = 0)
        {
