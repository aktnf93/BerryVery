...
<<<<<<< HEAD:BerryVery_Application/BerryServer/Common/RepositoryBaseEx.cs
...
>>>>>>> origin/main:BerryVery_Application/BerryServer/Repositories/RepositoryBaseEx.cs

        public RepositoryBaseEx(ILogger<Repository> logger, DatabaseConnection db)
        {
            // Type type = typeof(T);
