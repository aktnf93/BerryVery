...
namespace BerryServer.Controllers.Api
{
    ...
    /// - api/device/sub
    /// </summary>
<<<<<<< HEAD:BerryVery_Application/BerryServer/Route/Api/Device/DeviceController.cs
    [Route("api/[controller]")]
    //[ApiController]
=======
    [Route("api/[Controller]")]
    [ApiController]
>>>>>>> origin/main:BerryVery_Application/BerryServer/Controllers/Api/DeviceController.cs
